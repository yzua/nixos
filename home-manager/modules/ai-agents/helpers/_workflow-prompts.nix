...
let
  ...
  # Shared sections included in most workflows.
  # securityAudit and markdownSync omit changeControl.
  sharedSections = [
    repoDiscovery
    searchDiscipline
    validationDiscovery
...
in
{
  commitSplit = joinSections (
    ...
    ++ sharedSectionsWithChangeControl
    ++ [
      ''
        Execution sequence:
  ...
  runtimePerformance = joinSections (
    [
      ''
