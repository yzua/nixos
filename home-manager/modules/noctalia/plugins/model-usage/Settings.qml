    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                spacing: Style.marginM
                NToggle {
                    checked: editSettings?.providers?.zai?.enabled ?? false
                    onToggled: value => {
                        if (!editSettings.providers)
                            editSettings.providers = {};
                        if (!editSettings.providers.zai)
                            editSettings.providers.zai = {};
                        editSettings.providers.zai.enabled = value;
                        editSettingsChanged();
                    }
                }
                NText {
