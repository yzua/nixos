...
Item {
    ...
    Zai {
        id: zaiProvider
        enabled: root.providerEnabled("zai")
        providerSettings: root.pluginSettings?.providers?.zai ?? ({})
    }

    property var providers: [claudeProvider, codexProvider, copilotProvider, openRouterProvider, zenProvider, zaiProvider]
