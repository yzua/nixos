...
var SPOOF = {
    ...
    FINGERPRINT: "google/panther/panther:14/UQ1A.240205.002/12069354:user/release-keys",
    HARDWARE: "pixel",
...
Java.perform(function () {
    ...
    console.log("[spoof-build] Patched " + patched + " Build fields" + (failed > 0 ? " (" + failed + " failed)" : ""));
    console.log("[spoof-build] MODEL=" + Build.MODEL.value + " HARDWARE=" + Build.HARDWARE.value + " MFG=" + Build.MANUFACTURER.value);
    ...
    console.log("[spoof-build] File.exists hook active for " + HIDDEN_PATHS.length + " emulator paths");
});
