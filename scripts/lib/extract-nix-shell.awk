# AWK script: Extract inline writeShellScript/writeShellScriptBin bodies from .nix files.
# Used by shellcheck-nix-inline.sh to lint embedded shell scripts.
# Requires awk-utils.awk functions (count_char).
