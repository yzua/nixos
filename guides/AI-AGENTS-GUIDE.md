...
- **Functions** (`clg`, `ocg`, `oc-sops`, `cl-sops`, `oc-tmux`, `qq`, `deep`, `fix`) are defined in `terminal/zsh/default.nix` — needed for env var injection, sops key loading, or multi-line logic
